...
if __name__ == '__main__':
    ...
    parser.add_argument("--history_attention_input", default='reduce_mean', type=str, help="CLS, reduce_mean, reduce_max")
    parser.add_argument("--mtl_input", default="reduce_mean", type=str, help="CLS, reduce_mean, reduce_max")
    parser.add_argument("--aux_shared", default=False, type=bool, help="wheter to share the aux prediction layer with the main convqa model")
...
#        FLAGS.cache_dir = FLAGS.cache_dir[:-1] + '_{}/'.format(FLAGS.max_seq_length)
    ...
    if args.do_train:
        ...
        train_batches = cqa_gen_example_aware_batches_v2(train_features, example_tracker, variation_tracker, example_features_nums, 
                                                    batch_size=args.batch_size, num_epoches=2.0, shuffle=False)
