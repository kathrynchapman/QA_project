...
examples = read_quac_examples("/Users/kathrynchapman/Documents/Classes/QA_Seminar/datasets/QuAC/val_v0.2.json", is_training=False)
...
# feats = convert_examples_to_variations_and_then_features(examples, tokenizer=our_tokenizer, max_seq_length=384, doc_stride=128,
#                                                          max_query_length=64, max_considered_history_turns=11,
#                                                          is_training=False)

# examples = convert_examples_to_example_variations(examples, max_considered_history_turns=11)
